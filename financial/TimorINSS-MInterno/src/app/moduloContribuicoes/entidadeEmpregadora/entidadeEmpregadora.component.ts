...
import {MyErrorStateMatcher, MyErrorDataSuperiorStateMatcher, MyErrorDateSuperiorDataAtualStateMatcher} from '../../matcher';
...
export class EntidadeEmpregadoraComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (this.tokenStorage.getToken()) {
      ...
      if(idEntidade != null)
      {
        ...
        this.getDadosEntidadeEmpregadora();
  ...
  public getDadosEntidadeEmpregadora() {
      ...
      response => {
        ...
        if (this.responsavelLegalService.savedSuccessfully || this.responsavelLegalService.traceBack) {
          if (this.responsavelLegalService.savedSuccessfully) {
            openSnackBar(this.translate.instant('entidadeEmpregadora.responsavelGravado'), this._snackBar);
  ...
  public deleteMorada(data: any) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        this.getTableMorada();
        openSnackBar(this.translate.instant('entidadeEmpregadora.addressRemoved'), this._snackBar);
      }
    });
  }
  ...
  public deleteContato(data: any) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        this.getTableContato();
        openSnackBar(this.translate.instant('entidadeEmpregadora.contactRemoved'), this._snackBar);
      }
    });
  }
  ...
  public deleteResponsavelLegal(data: any) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        this.getTableResponsavelLegal();
        openSnackBar(this.translate.instant('entidadeEmpregadora.responsavelRemoved'), this._snackBar);
      }
    });
  }
  ...
  deleteSuspensao(data: any) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        this.getTableSuspensao();
        this.getDadosEntidadeEmpregadora();
        openSnackBar(this.translate.instant('entidadeEmpregadora.removeSuspensao'), this._snackBar);
      }
    });
  }
