...
{
    public partial class TimorINSSModuloContribuicoesTesteContext : DbContext
    {
        public TimorINSSModuloContribuicoesTesteContext()
        {
        }

        public TimorINSSModuloContribuicoesTesteContext(DbContextOptions<TimorINSSModuloContribuicoesTesteContext> options)
            : base(options)
        {
        }
